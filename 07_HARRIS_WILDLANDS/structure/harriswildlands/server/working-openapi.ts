/**
 * Working OpenAPI Documentation Generator for BruceOps API
 * 
 * This module generates a basic OpenAPI 3.0 specification for the BruceOps API.
 */

export function generateWorkingOpenAPISpec() {
  return {
    openapi: '3.0.0',
    info: {
      title: 'BruceOps API',
...
**Built with ❤️ for intentional living and creation**`,
      contact: {
        name: 'Bruce Harris',
    ...
    components: {
      ...
      schemas: {
        ...
        NotFoundError: {
          type: 'object',
          properties: {
            message: { type: 'string', description: 'Resource not found message' },
          },
        },
        UnauthorizedError: {
          type: 'object',
          properties: {
            message: { type: 'string', description: 'Unauthorized access message' },
          },
        },
        HealthResponse: {
          type: 'object',
          properties: {
            ...
            ai_provider: { type: 'string', enum: ['openai', 'gemini', 'openrouter', 'off'] },
            ai_status: { type: 'string', enum: ['active', 'degraded', 'offline'] },
          },
        },
        UserResponse: {
          type: 'object',
        ...
        Log: {
          ...
          properties: {
            ...
            moneyPressure: { type: 'number', minimum: 1, maximum: 10 },
            connection: { type: 'number', minimum: 1, maximum: 10 },
            vaping: { type: 'boolean' },
            alcohol: { type: 'boolean' },
            junkFood: { type: 'boolean' },
            doomScrolling: { type: 'boolean' },
            lateScreens: { type: 'boolean' },
            skippedMeals: { type: 'boolean' },
            excessCaffeine: { type: 'boolean' },
            exercise: { type: 'boolean' },
            dayType: { type: 'string', enum: ['work', 'rest', 'family', 'mixed', 'chaos'] },
            primaryEmotion: { type: 'string' },
            winCategory: { type: 'string' },
            timeDrain: { type: 'string' },
            topWin: { type: 'string' },
            topFriction: { type: 'string' },
        ...
        Idea: {
          ...
          properties: {
            ...
            captureMode: { type: 'string', enum: ['quick', 'deep'] },
            whoItHelps: { type: 'string' },
            painItSolves: { type: 'string' },
            whyICare: { type: 'string' },
            tinyTest: { type: 'string' },
            resourcesNeeded: { type: 'string' },
            timeEstimate: { type: 'string' },
            excitement: { type: 'number', minimum: 1, maximum: 10 },
            feasibility: { type: 'number', minimum: 1, maximum: 10 },
            status: { type: 'string', enum: ['draft', 'parked', 'promoted', 'shipped', 'discarded'] },
            priority: { type: 'number', minimum: 0, maximum: 5 },
            realityCheck: { type: 'object' },
            promotedSpec: { type: 'object' },
...
export default generateWorkingOpenAPISpec;